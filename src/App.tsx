...
function App() {
    ...
    // const characterArray = (text:string) => {
    //     characterArrayFull.filter(character => character.name === text)
    // }


    // function filterGalleryFullGallery(characterArrayFull){
    //     return  <div className={"character-gallery"}>{characterArrayFull.map(character => <CharacterCard character = {character} />)
    ...
    return (
        <div className="App">
            ...
            <Gallery characters={characterArrayFull.filter(character => character.name.includes(count))}/>
        </div>
    );
}
